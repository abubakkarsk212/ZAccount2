...
public class UsssdBankingIndian extends AppCompatActivity {
    ...
    String[] profileMethod = {"Change Bank Account","Change Language","My Details","UPI Id","Manage Beneficiary"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usssd_banking_indian);
        adView = new com.facebook.ads.AdView(UsssdBankingIndian.this, getString(R.string.banner_UssdRbl), AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer =findViewById(R.id.banner_indianU1);
        adContainer.addView(adView);
        adView.setAdListener(new AbstractAdListener() {
            @Override
            public void onError(Ad ad, AdError adError) {
                // Ad error callback
                Toast.makeText(UsssdBankingIndian.this, "Connection issue" + adError.getErrorMessage(),
                        Toast.LENGTH_LONG).show(); }});
        adView.loadAd();
        interstitialAd =new com.facebook.ads.InterstitialAd(UsssdBankingIndian.this,getString(R.string.interstitial_UssdRbl));
        ...
        send = findViewById(R.id.sendInd);
        request = findViewById(R.id.reqestIn);
        profile = findViewById(R.id.profileIn);
        pendingR = findViewById(R.id.pendingIn);
        transaction = findViewById(R.id.transactionIn);
        upiP = findViewById(R.id.upiInd);
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(UsssdBankingIndian.this);
        ...
        mNativeBannerAxis1= new NativeBannerAd(UsssdBankingIndian.this, getString(R.string.nativebannerUssdRbl1));
...
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UsssdBankingIndian.this, mNativeBannerAxis1, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_banksindianU1);
        ...
        mNativeBannerAxis2= new NativeBannerAd(UsssdBankingIndian.this, getString(R.string.nativebannerUssdRbl2));
        //623848994653940_626245771080929
        mNativeBannerAxis2.setAdListener(new NativeAdListener() {
            ...
            public void onAdLoaded(Ad ad) {
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UsssdBankingIndian.this, mNativeBannerAxis2, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_banksindianU2);
                // Add the Native Banner Ad View to your ad container
                nativeBannerAdContainer1.addView(adView1);
            }
