...
public class UssdBankingIcici extends AppCompatActivity {
    LinearLayout send,request,profile,pendingR,transaction,upiP;
    String[] sendMethod = {"Mobile No","Aadhar No","Payment Address","Saved Benificiary","IFSC,Account No","MMID"};
    String[] profileMethod = {"Change Bank Account","Change Language","My Details","Manage Beneficiary","My Queries(Status of transaction)","Add Payment Address"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ussd_banking_icici);
        adView = new com.facebook.ads.AdView(UssdBankingIcici.this, getString(R.string.banner_UssdA), AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer =findViewById(R.id.banner_iciciU1);
        adContainer.addView(adView);
        adView.setAdListener(new AbstractAdListener() {
            @Override
            public void onError(Ad ad, AdError adError) {
                // Ad error callback
                Toast.makeText(UssdBankingIcici.this, "Connection issue" + adError.getErrorMessage(),
                        Toast.LENGTH_LONG).show(); }});
        adView.loadAd();
        interstitialAd =new com.facebook.ads.InterstitialAd(UssdBankingIcici.this,getString(R.string.interstitial_UssdA));
        ...
        send = findViewById(R.id.sendSbiI);
        request = findViewById(R.id.reqI);
        profile = findViewById(R.id.profileI);
        pendingR = findViewById(R.id.pendingI);
        transaction = findViewById(R.id.transactionI);
        upiP = findViewById(R.id.upiIcici);
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(UssdBankingIcici.this);
        ...
        mNativeBannerAxis1= new NativeBannerAd(UssdBankingIcici.this, getString(R.string.nativebannerUssdA1));
...
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UssdBankingIcici.this, mNativeBannerAxis1, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_banksiciciU1);
        ...
        mNativeBannerAxis2= new NativeBannerAd(UssdBankingIcici.this, getString(R.string.nativebannerUssdA2));
        //623848994653940_626245771080929
        mNativeBannerAxis2.setAdListener(new NativeAdListener() {
            ...
            public void onAdLoaded(Ad ad) {
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UssdBankingIcici.this, mNativeBannerAxis2, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_banksiciciU2);
                // Add the Native Banner Ad View to your ad container
                nativeBannerAdContainer1.addView(adView1);
            }
