...
public class UssdIdfc extends AppCompatActivity {
    LinearLayout send,request1,profile,pendingR,transaction,upiP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ussd_idfc);
        adView = new com.facebook.ads.AdView(UssdIdfc.this, getString(R.string.banner_UssdSbi), AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer =findViewById(R.id.banner_idfcU1);
        adContainer.addView(adView);
        adView.setAdListener(new AbstractAdListener() {
            @Override
            public void onError(Ad ad, AdError adError) {
                // Ad error callback
                Toast.makeText(UssdIdfc.this, "Connection issue" + adError.getErrorMessage(),
                        Toast.LENGTH_LONG).show(); }});
        adView.loadAd();
        interstitialAd =new com.facebook.ads.InterstitialAd(UssdIdfc.this,getString(R.string.interstitial_UssdSbi));
        ...
        send = findViewById(R.id.sendIdfc);
        request1 = findViewById(R.id.reqIdfc);
        profile = findViewById(R.id.profileIdfc);
        pendingR = findViewById(R.id.pendingIdfc);
        transaction = findViewById(R.id.transactionIdf);
        upiP = findViewById(R.id.upiIdfc);
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(UssdIdfc.this);
        ...
        mNativeBannerAxis1= new NativeBannerAd(UssdIdfc.this, getString(R.string.nativebannerUssdSbi1));
...
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UssdIdfc.this, mNativeBannerAxis1, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_banksidfcU1);
        ...
        mNativeBannerAxis2= new NativeBannerAd(UssdIdfc.this, getString(R.string.nativebannerUssdSbi2));
        //623848994653940_626245771080929
        mNativeBannerAxis2.setAdListener(new NativeAdListener() {
            ...
            public void onAdLoaded(Ad ad) {
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UssdIdfc.this, mNativeBannerAxis2, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_banksidfcU2);
                // Add the Native Banner Ad View to your ad container
                nativeBannerAdContainer1.addView(adView1);
            }
