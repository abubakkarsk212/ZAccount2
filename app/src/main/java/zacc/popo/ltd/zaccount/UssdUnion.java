...
public class UssdUnion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ussd_union);
        adView = new com.facebook.ads.AdView(UssdUnion.this, getString(R.string.banner_UssdRbl), AdSize.BANNER_HEIGHT_50);
        ...
        adView.setAdListener(new AbstractAdListener() {
            ...
            public void onError(Ad ad, AdError adError) {
                // Ad error callback
                Toast.makeText(UssdUnion.this, "Connection issue" + adError.getErrorMessage(),
                        Toast.LENGTH_LONG).show(); }});
        adView.loadAd();
        interstitialAd =new com.facebook.ads.InterstitialAd(UssdUnion.this,getString(R.string.interstitial_UssdRbl));
        ...
        send = findViewById(R.id.sendUni);
        request1 = findViewById(R.id.reqUni);
        profile = findViewById(R.id.profileUni);
        pendingR = findViewById(R.id.pendingUni);
        transaction = findViewById(R.id.transactionUni);
        upiP = findViewById(R.id.upiUni);
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(UssdUnion.this);
        ...
        mNativeBannerAxis1= new NativeBannerAd(UssdUnion.this, getString(R.string.nativebannerUssdRbl1));
...
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UssdUnion.this, mNativeBannerAxis1, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_banksunionU1);
        ...
        mNativeBannerAxis2= new NativeBannerAd(UssdUnion.this, getString(R.string.nativebannerUssdRbl2));
        //623848994653940_626245771080929
        mNativeBannerAxis2.setAdListener(new NativeAdListener() {
            ...
            public void onAdLoaded(Ad ad) {
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UssdUnion.this, mNativeBannerAxis2, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_banksunionU2);
                // Add the Native Banner Ad View to your ad container
                nativeBannerAdContainer1.addView(adView1);
            }
