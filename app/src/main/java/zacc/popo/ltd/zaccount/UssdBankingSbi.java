...
public class UssdBankingSbi extends AppCompatActivity {
...
String[] sendMethod = {"Mobile No","Payment Address","Saved Benificiary","IFSC,Account No","MMID"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ussd_banking_sbi);
        adView = new com.facebook.ads.AdView(UssdBankingSbi.this, getString(R.string.banner_UssdSbi), AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer =findViewById(R.id.banner_sbiU1);
        adContainer.addView(adView);
        adView.setAdListener(new AbstractAdListener() {
            @Override
            public void onError(Ad ad, AdError adError) {
                // Ad error callback
                Toast.makeText(UssdBankingSbi.this, "Connection issue" + adError.getErrorMessage(),
                        Toast.LENGTH_LONG).show(); }});
        adView.loadAd();
        interstitialAd =new com.facebook.ads.InterstitialAd(UssdBankingSbi.this,getString(R.string.interstitial_UssdSbi));
        ...
        send = findViewById(R.id.sendSbi);
        request = findViewById(R.id.reqSbi);
        profile = findViewById(R.id.profileSbi);
        pendingR = findViewById(R.id.pendingSbi);
        transaction = findViewById(R.id.transactionSbi);
        upiP = findViewById(R.id.upiSbi);
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(UssdBankingSbi.this);
        ...
        mNativeBannerAxis1= new NativeBannerAd(UssdBankingSbi.this, getString(R.string.nativebannerUssdSbi1));
...
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UssdBankingSbi.this, mNativeBannerAxis1, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_bankssbiU1);
        ...
        mNativeBannerAxis2= new NativeBannerAd(UssdBankingSbi.this, getString(R.string.nativebannerUssdSbi2));
        //623848994653940_626245771080929
        mNativeBannerAxis2.setAdListener(new NativeAdListener() {
            ...
            public void onAdLoaded(Ad ad) {
// Render the Native Banner Ad Template
                View adView1 = NativeBannerAdView.render(UssdBankingSbi.this, mNativeBannerAxis2, NativeBannerAdView.Type.HEIGHT_100);
                LinearLayout nativeBannerAdContainer1 = findViewById(R.id.native_bankssbiU2);
                // Add the Native Banner Ad View to your ad container
                nativeBannerAdContainer1.addView(adView1);
            }
